...
namespace Deleeteme
{
    public static partial class SmallTitlesExtensions
    {
        ...
        /// Reference to the Deleeteme.ISmallTitles.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.SmallTitle> result = await operations.DeletesmallTitleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.SmallTitle> result = await operations.GetsmallTitleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.SmallTitle> result = await operations.PostsmallTitleWithOperationResponseAsync(smallTitle, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
