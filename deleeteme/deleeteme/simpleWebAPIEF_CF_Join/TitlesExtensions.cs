...
namespace Deleeteme
{
    public static partial class TitlesExtensions
    {
        ...
        /// Reference to the Deleeteme.ITitles.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.Title> result = await operations.DeletetitleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Deleeteme.Models.SmallTitle>> result = await operations.GetsmallTitlesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.Title> result = await operations.GettitleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Deleeteme.Models.Title>> result = await operations.GettitlesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.Title> result = await operations.PosttitleWithOperationResponseAsync(title, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
