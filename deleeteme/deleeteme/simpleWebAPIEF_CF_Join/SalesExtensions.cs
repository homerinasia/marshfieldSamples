...
namespace Deleeteme
{
    public static partial class SalesExtensions
    {
        ...
        /// Reference to the Deleeteme.ISales.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.Sale> result = await operations.DeletesaleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.Sale> result = await operations.GetsaleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<Deleeteme.Models.Sale>> result = await operations.GetsalesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Deleeteme.Models.Sale> result = await operations.PostsaleWithOperationResponseAsync(sale, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
