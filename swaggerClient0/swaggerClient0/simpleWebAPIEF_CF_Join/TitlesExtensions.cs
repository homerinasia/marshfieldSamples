...
namespace SwaggerClient0
{
    public static partial class TitlesExtensions
    {
        ...
        /// Reference to the SwaggerClient0.ITitles.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<SwaggerClient0.Models.Title> result = await operations.DeletetitleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<SwaggerClient0.Models.Title> result = await operations.GettitleWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<SwaggerClient0.Models.Title>> result = await operations.GettitlesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<SwaggerClient0.Models.Title> result = await operations.PosttitleWithOperationResponseAsync(title, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
